...
Public IP address: 34.213.124.212
SSH port: 2200
Username:*grader*
...
[Clone or downoad Proj4](https://github.com/Teraisa/Proj4.git) into your server so that it operates properly while using the IP address in a browser.

Finally, deploy your application via your server using the IP
...
`ssh ubuntu@34.213.124.212 -i ~/.ssh/lightsailKey.pem`

*If* you are denied access with the *WARNING:
UNPROTECTED PRIVATE KEY FILE!* change:
`chmod 400 ~/UnleashKey.pem`
*Then* login:
`ssh ubuntu@34.213.124.212 -i ~/UnleashKey.pem`

**Optional** Pull up another terminal window and test your command to *double check*:
`ssh ubuntu@34.213.124.212 -i ~/UnleashKey.pem`

>####**See Also: [Get started on Lightsail,](https://classroom.udacity.com/nanodegrees/nd004-connect/parts/63d60eee-becf-43eb-8cfe-bbad19a4cd43/modules/357367901175462/lessons/3573679011239847/concepts/c4cbd3f2-9adb-45d4-8eaf-b5fc89cc606e) [After setting up your AWS Lightsail,](https://discussions.udacity.com/t/setting-up-lightsail-ports/273747) [Issues deploying application to Lightsail](https://discussions.udacity.com/t/issues-deploying-application-to-lightsail/403522)
...
**Optional** Pull up another terminal window (**local machine**) and test: 
`ssh -i ~/.ssh/id_rsa grader@34.213.124.212`
